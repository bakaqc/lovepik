...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2023 at 12:46 PM
...
(14, 3, 'Hoa Hồng Xanh', 'img/product_img/hoa-hong-xanh.png', '', 283000, 'Hoa hồng  là loại hoa tượng trưng cho tình yêu vĩnh hằng, mối tình cảm cao quý và sâu đậm.'),
(15, 2, 'Hoa Ly Vàng', 'img/product_img/hoa-ly-vang.png', '', 174000, 'Hoa ly màu vàng là biểu tượng mang nhiều tầng nghĩa khác nhau, vì màu sắc có một số ý nghĩa tích cực gắn liền. Chúng bao gồm hạnh phúc, lòng trung thành, khởi đầu mới, cảm giác tươi mới và ánh nắng mặt trời.'),
...
(37, 5, 'Cây Phát Tài', 'img/product_img/cay-phat-tai.png', '', 400000, 'Cây Phát Tàilà loài cây mang lại may mắn, tài lộc sung túc cho cả gia đình. Theo phong thủy, số lượng cây phát tài, phát lộc được trồng trong một chậu sẽ có ý nghĩa khác nhau. 2 cây: Tình duyên và hôn nhân.\r\n3 cây: Mang đến hạnh phúc, trường thọ, sự giàu có. 5 cây: Sức khỏe. 8 cây: Thịnh vượng, phát tài. 9 cây: May mắn.'),
