...
<!--        <script type="text/javascript">
            function redirectToSignupPage() {
                window.location = "admin_signup.jsp";
            }
        </script>-->
    </head>
    <body>
                            ...
                            <div class="card-body p-5 text-center"style="border-radius: 1rem;background-color: antiquewhite;border:solid 5px white;">
                                ...
                                <form action="admin" method="post" > 
                                    ...
                                    <div class="mb-md-5 mt-md-4 pb-5">
                                        ...
                                        <p class="text-black-50 mb-5">Please enter username and password!</p>

                                        <div class="form-outline form-white mb-4">
                                            <input type="username" id="typeEmailX" class="form-control form-control-lg" />
                                            <label class="form-label" for="typeEmailX" style="color: black">Username</label>
                                        </div>
                                        ...
                                        <input class="btn btn-outline-light btn-lg px-5" type="submit"  value="Login" action="admin" method="post" style="font-weight: bold; color: black; background-color: orange;"/>
